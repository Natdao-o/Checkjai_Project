export const EQ_CHOICES_TH = ['ไม่จริง', 'จริงบางครั้ง', 'ค่อนข้างจริง', 'จริงมาก'] as const

export const EQ_QUESTIONS_TH = [
  ...
  'รู้สึกลำบากใจในการทำสิ่งใดสิ่งหนึ่งเพื่อผู้อื่น',
  'ไม่รู้ว่าฉันเก่งเรื่องอะไร',
  ...
  'ฉันมักทุกข์ร้อนกับเรื่องเล็กๆน้อยๆ ที่เกิดขึ้นเสมอ',
] as const
